...
export const CH_HOMEPAGE_URI = `https://find-and-update.company-information.service.gov.uk/`
...
export const CHANGE_DETAILS_URI = `${ROOT_URI}/change-details`
export const APPLICATION_STATUS_URI = `${ROOT_URI}/application-status`
...
const PAYMENT_URI = `${ROOT_URI}/payment`
