...
export const BANNER_FEEDBACK_LINK = 'https://www.research.net/r/closing-a-company-feedback'
export const CONFIRMATION_FEEDBACK_LINK = 'https://www.research.net/r/closing-a-company-confirmation'
