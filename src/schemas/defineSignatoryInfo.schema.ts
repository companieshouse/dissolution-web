...
import {
    generateSchemaForCorporateSignatoryDetails,
    generateSchemaForIndividualSignatoryDetails,
} from "./signatoryDetails.schema";
...
function generateSchemaForSignatories(signatories: DirectorToSign[]): Joi.SchemaMap {
    return signatories.reduce(
        (schema: Joi.SchemaMap, signatory: DirectorToSign) => ({
            ...schema,
