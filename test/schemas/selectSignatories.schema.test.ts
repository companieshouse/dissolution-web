...
describe("Select Signatories Schema", () => {
    ...
    describe("Signatories required errors", () => {
        const requiredCases = [
            {
                ...
                expected: "Select the directors who will sign the application.",
            },
            {
                officerType: OfficerType.MEMBER,
                isApplicantADirector: false,
                expected: "Select the members who will sign the application.",
            },
            {
                officerType: OfficerType.DIRECTOR,
                isApplicantADirector: true,
                expected: "Select the other directors who will sign the application.",
            },
            {
                officerType: OfficerType.MEMBER,
                isApplicantADirector: true,
                expected: "Select the other members who will sign the application.",
            },
        ];
        ...
        requiredCases.forEach(c => {
            it(`should show required error for signatories (${c.officerType}, isApplicantADirector=${c.isApplicantADirector})`, () => {
                ...
                const errors: ValidationResult = selectSignatoriesSchema(
                    c.officerType,
                    3,
                    c.isApplicantADirector
    ...
    describe("Minimum number of signatories required errors", () => {
        const minSignatoryCases = [
            {
                officerType: OfficerType.DIRECTOR,
                expected: "Select 3 or more directors who will sign the application.",
            },
