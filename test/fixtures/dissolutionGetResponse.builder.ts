...
export class DissolutionGetResponseBuilder {
    ...
    private directors: DissolutionGetDirector[] = [
        aDissolutionGetDirector().withOfficerId("abc123").build(),
        aDissolutionGetDirector().withOfficerId("abc124").build(),
    ];
    ...
    withApplicationStatus(status: ApplicationStatus): this {
        this.application_status = status;
        return this;
    }
    withApplicationReference(ref: string): this {
        this.application_reference = ref;
        return this;
    }
    withApplicationType(type: ApplicationType): this {
        this.application_type = type;
        return this;
    }
    withCompanyNumber(num: string): this {
    ...
    withCertificateBucket(bucket: string): this {
        this.certificate_bucket = bucket;
        return this;
    }
    withCertificateKey(key: string): this {
        this.certificate_key = key;
        return this;
    }
