...
export class DissolutionGetResponseBuilder {
    ...
    private directors = [aDissolutionGetDirector().withOfficerId("abc123").build(), aDissolutionGetDirector().withOfficerId("abc124").build()]
    ...
    withDirectors (directors: any[]): this { this.directors = directors; return this }
