...
describe("PayByAccountDetailsController", () => {
    ...
    describe("GET request", () => {
        ...
        it("should reject with an error (if toggle is disabled)", async () => {
            ...
            await request(app).get(PAY_BY_ACCOUNT_DETAILS_URI).expect(StatusCodes.NOT_FOUND);
        });
        ...
        it("should render the pay by account details page (if toggle is enabled)", async () => {
            ...
            const res = await request(app).get(PAY_BY_ACCOUNT_DETAILS_URI).expect(StatusCodes.OK);
    ...
    describe("POST request", () => {
        ...
        it("should re-render the view with an error if validation fails", async () => {
            ...
            const res = await request(app).post(PAY_BY_ACCOUNT_DETAILS_URI).send(form).expect(StatusCodes.BAD_REQUEST);
