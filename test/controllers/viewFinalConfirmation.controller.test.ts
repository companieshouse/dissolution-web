...
describe("ViewFinalConfirmationController", () => {
    ...
    const DIRECTORS_INSTRUCTION =
        "The directors must send a copy to all interested parties within 7 days of making the application.";
    const MEMBERS_INSTRUCTION =
        "The members must send a copy to all interested parties within 7 days of making the application.";
    ...
    const WARNING_TEXT =
        "It is a criminal offence not to tell all interested parties that an application has been made to close the company.";
    const EMAIL_CONFIRM_TEXT = "We'll email you to confirm that we've received the application.";
    const EMAIL_RESULT_TEXT =
        "We'll email you again within 2 working days to let you know if the application has been accepted or rejected.";
    ...
    const WHAT_NEXT_DISSOLVE =
        "After 2 months, unless there is an objection to the company closing, another notice will be published in the relevant Gazette and the company will be dissolved.";
