...
import {
    ...
    generateCompanyOfficersResource,
...
describe("CompanyOfficersService", () => {
    ...
    beforeEach(() => {
        ...
        service = new CompanyOfficersService(instance(client), instance(directorMapper));
    });
    ...
    describe("getActiveDirectorsForCompany", () => {
        ...
        it("should filter out officers who are not directors or members", async () => {
            ...
            const corporateDirector: CompanyOfficer = {
                ...generateCompanyOfficer(),
                officerRole: OfficerRole.CORPORATE_DIRECTOR,
            };
            const corporateNomineeDirector: CompanyOfficer = {
                ...generateCompanyOfficer(),
                officerRole: OfficerRole.CORPORATE_NOMINEE_DIRECTOR,
            };
            const judicialFactor: CompanyOfficer = {
                ...generateCompanyOfficer(),
                officerRole: OfficerRole.JUDICIAL_FACTOR,
            };
            ...
            const llpDesignatedMember: CompanyOfficer = {
                ...generateCompanyOfficer(),
                officerRole: OfficerRole.LLP_DESIGNATED_MEMBER,
            };
            const corporateLlpMember: CompanyOfficer = {
                ...generateCompanyOfficer(),
                officerRole: OfficerRole.CORPORATE_LLP_MEMBER,
            };
        ...
        it("should map the director details of each active director and return them", async () => {
            ...
            const director2: CompanyOfficer = {
                ...generateCompanyOfficer(),
                officerRole: OfficerRole.CORPORATE_DIRECTOR,
            };
    ...
    describe("getOfficerRoleById", () => {
        it("should return the officer role for a given officer ID (API fetch)", async () => {
            ...
            const officerId =
                officer.links && officer.links.officer && officer.links.officer.appointments.split("/")[2];
